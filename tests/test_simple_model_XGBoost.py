...
def test_simple_predictor():
    ...
    predictor = SimplePredictorXGBoost()
    ...
    # Remap des classes pour compatibilité XGBoost/multi-class
    remap = {-1: 0, 0: 1, 1: 2}
    ...
    test_metrics = predictor.evaluate(X_test, y_test_remap, X_train, y_train_bal)
